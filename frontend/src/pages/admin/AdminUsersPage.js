...
const AdminUsersPage = () => {
  ...
  const handleStatusToggle = async (userId, currentStatus) => {
    try {
      ...
      setUsers(users.map((user) => (user._id === userId ? { ...user, active: newStatus } : user)));
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      ...
      setStats((prev) => ({
        ...
        [deletedUser.active !== false ? 'active' : 'inactive']:
          prev[deletedUser.active !== false ? 'active' : 'inactive'] - 1,
      }));
    } catch (err) {
                    ...
                    <tbody>
                      {filteredUsers.map((user) => (
                        <tr key={user._id}>
                          ...
                          <td>
                            <span
                              className={`status-badge ${user.active !== false ? 'active' : 'inactive'}`}
                            >
                    ...
                    <div className="profile-details">
                      <dl className="detail-list">
                        ...
                        <div className="detail-group">
                          ...
                          <dd>
                            <span
                              className={`status-badge ${selectedUser.active !== false ? 'active' : 'inactive'}`}
                            >
