          ...
          <div className="row g-4">
            <div className="col-12 col-lg-8">
              ...
              <div className="card mb-4">
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-end gap-2 overflow-auto" style={{ minHeight: '200px' }}>
                    {earnings.map((item, index) => (
                      <div key={index} className="d-flex flex-column align-items-center" style={{ minWidth: '60px' }}>
                        <div 
                        ...
                        >
                          <span className="position-absolute" style={{ top: '-20px', fontSize: '10px', color: '#000' }}>
                            ${item.amount}
                          </span>
                        </div>
                ...
                <div className="card-body">
                  <div className="d-flex flex-column gap-3">
                    <div className="d-flex justify-content-between align-items-center p-2 bg-light rounded">
                      ...
                      <span className="fw-bold text-primary fs-5">{customerStats.totalCustomers}</span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center p-2 bg-light rounded">
                      <span className="text-muted">New Customers</span>
                      <span className="fw-bold text-success fs-5">{customerStats.newCustomers}</span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center p-2 bg-light rounded">
                      <span className="text-muted">Repeat Customers</span>
                      <span className="fw-bold text-info fs-5">{customerStats.repeatCustomers}</span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center p-2 bg-light rounded">
                      <span className="text-muted">Avg. Customer Value</span>
                      <span className="fw-bold text-warning fs-5">${customerStats.avgCustomerValue}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card-body">
                  <div className="d-flex flex-column gap-2">
                    {customerStats.topCustomers?.map((customer, index) => (
                      <div key={index} className="d-flex align-items-center gap-3 p-2 border rounded">
                  ...
                  <div className="row g-4">
                      ...
                      <div className="p-3 border rounded">
                        ...
                        <div className="progress mb-2" style={{ height: '8px' }}>
                          <div 
                            ...
                            role="progressbar"
                            style={{ width: `${Math.min((reportData.totalEarnings / 2000) * 100, 100)}%` }}
                        ...
                        <small className="text-muted">
                          ${reportData.totalEarnings} / $2,000 ({((reportData.totalEarnings / 2000) * 100).toFixed(1)}%)
                        </small>
                      </div>
                    </div>
                    ...
                    <div className="col-12 col-md-6">
                      <div className="p-3 border rounded">
                        ...
                        <small className="text-muted">
                          {reportData.avgRating} / 5.0 ({((reportData.avgRating / 5) * 100).toFixed(1)}%)
                        </small>
                      </div>
                    </div>
                  </div>
